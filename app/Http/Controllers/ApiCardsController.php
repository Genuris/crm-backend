...
//        dd($query_);
    ...
    public function setStatusCardRequest(Request $request) {
        ...
        if ($card_request_status) {
            if (isset($status)) {
                $card_request_status->status = (is_null($status) ? null : $status);
            }
            if (isset($show_time)) {
                $card_request_status->show_time = (is_null($show_time) ? null : (int)$show_time);
            }
            ...
            if (isset($status)) {
                $data['status'] = (is_null($status) ? null : $status);
            }
            if (isset($show_time)) {
                $data['show_time'] = (is_null($show_time) ? null : (int)$show_time);
            }
